    ...
    <footer className="bg-brand-bg border-t border-zinc-800 py-12 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <h4 className="font-mono text-xs uppercase tracking-widest text-white mb-4">Technical</h4>
          <ul className="space-y-3 text-[10px] font-mono uppercase tracking-widest">
            <li><a href="/llms.txt" className="hover:text-brand-green transition-colors">AI Context (llms.txt)</a></li>
            <li><a href="/manifesto.md" className="hover:text-brand-green transition-colors">Manifesto (.md)</a></li>
          </ul>
        </div>
      </div>
